...
/**
 * The Task class represents a User's task with taskid, bidstatus, title, description, bidlist
 * location, photos, requesteddate, hasnewbids, requesters, and providers.
 *
 * @author Team 22
 * @version 1.1
 * @see User
